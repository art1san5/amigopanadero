    ...
    public function run()
    {
        DB::table('recipes')->insert([
            array(
                ...
                'title' => 'Loaf Bread',
                'sponge' => json_encode([
                    'Montana Spring Hard Flour 60 Bakers% / 600g',
                    'Instant Yeast 0.8 Bakers% / 8g',
                    'Water 60 Bakers% / 360g',
                ]),
                'dough' => json_encode([
                    'Montana Spring Hard Flour 40 Bakers% / 400g',
                    'Water 48 Bakers% / 120g',
                    'Instant Yeast 0.2 Bakers% / 2g',
                    'Skim Milk 0.4 Bakers% / 40g',
                    'Salt 1.5 Bakers% / 15g',
                    'Sugar 16 Bakers% / 15g',
                    'Shortening 4 Bakers% / 40g',
                    'Bread Improver 0.4 Bakers% / 4g'
                ]),
            ...
            array(
                ...
                'sponge' => json_encode([
                    'Montana Spring Hard Flour 70 Bakers% / 700g',
                    'Instant Yeast 1.5 Bakers% / 15g',
                    'Water 60 Bakers% / 420g',
                ]),
                'dough' => json_encode([
                    'Whole Wheat Flour 30 Bakers% / 300g',
                    'Water 48 Bakers% / 60g',
                    'Salt 1.5 Bakers% / 15g',
                    'Brown Sugar 8 Bakers% / 80g',
                    'Honey 6 Bakers% / 60g',
                    'Shortening 4 Bakers% / 40g',
                    'Milk Powder 4 Bakers% / 40g',
                    'Molasses 2 Bakers% / 20g',
                    'Improver 0.4 Bakers% / 4g'
                ]),
                'procedure' => json_encode([
                    'To make the sponge: In a small bowl, combine Montana Hard Flour and instant yeast. In the bowl of the mixer with the spiral attachment, mix the blended flour and yeast with water. Knead on speed 1 to combine. Place the kneaded dough in a lightly greased bowl, cover with plastic wrap and set aside to ferment for 3 hours.',
            ...
            array(
                ...
                'sponge' => '',
                'dough' => json_encode([
                    'Montana Spring Hard Flour 100 Bakers% / 1000g',
                    'Water 57 Bakers% / 570g',
                    'Instant Yeast, Low Sugar 1.0 Bakers% / 10g',
                    'White Sugar 1.0 Bakers% / 10g',
                    'Salt 2.0 Bakers% / 20g',
                    'Improver 0.6 Bakers% / 6g',
                ]),
                'procedure' => json_encode([
            ...
            array(
                ...
                'dough' => json_encode([
                    'Montana Spring Hard Flour 100 Bakers% / 1000g',
                    'Water 50 Bakers% / 500g',
                    'Instant Yeast 1 Bakers% / 10g',
                    'Sugar 15 Bakers% / 150g',
                    'Salt 1.5 Bakers% / 15g',
                    'Milk Powder 4 Bakers% / 40g',
                    'Bread Improvers 0.4 Bakers% / 4g',
                    'Shortening 8 Bakers% / 80g'
                ]),
                'procedure' => json_encode([
